      ...
      images: [
        {
          ...
          referenceRolesJson: [{ key: 'generated-images/reference.png', roles: ['CHARACTER'] }],
          characterCompositeJson: {
            sourceKey: 'generated-images/reference.png',
            cutoutKey: 'cutouts/image-copy-1/hash.png',
            position: 'RIGHT',
            heightRatio: 0.9,
          },
      ...
      images: [
        {
          ...
          sizePreset: 'landscape_1200x628',
          referenceKeys: ['generated-images/reference.png'],
          referenceRolesJson: JSON.stringify([
            { key: 'generated-images/reference.png', roles: ['CHARACTER'] },
          ]),
          characterCompositeJson: JSON.stringify({
            sourceKey: 'generated-images/reference.png',
            cutoutKey: 'cutouts/image-copy-1/hash.png',
            position: 'RIGHT',
            heightRatio: 0.9,
