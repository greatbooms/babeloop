...
export const pageGuides: Record<PageGuideKey, PageGuide> = {
  ...
  ads: {
    role: '경쟁사 광고를 모으고 분석해 브리프(광고 기획서)의 재료로 만드는 루프의 시작 화면입니다. 분석까지 끝나도 브리프가 자동으로 만들어지지는 않습니다 — 상세의 「브리프 생성」 또는 브리프 탭에서 직접 실행합니다.',
    steps: [
      'CSV 또는 수동 입력으로 광고를 등록합니다.',
      '상세에서 ① 미디어 텍스트 추출 → ② 광고 분석을 실행합니다. 분석된 광고는 유사 검색과 브리프 참조 재료가 됩니다.',
      '③ 브리프 생성 — 이 광고를 참조로 지정해 기획서를 만듭니다. (브리프 탭에서 포커스 문장으로 만들면 비슷한 분석 광고 3건이 자동 참조됩니다)',
    ],
    buttons: [
      { name: '미디어 텍스트 추출', description: '① 이미지 글자·영상 음성을 텍스트로 추출 (AI, 건당 1~2센트)' },
      { name: '광고 분석', description: '② 추출된 텍스트로 훅·타깃·감정 분류 + 검색용 임베딩 생성 (AI, ~1센트)' },
      { name: '브리프 생성', description: '③ 이 광고를 직접 참조로 지정해 광고 기획서 생성 (AI, ~1~2센트)' },
      { name: '유사 광고', description: '비슷한 메시지의 광고 검색 (무료, 보조 도구)' },
      { name: '재다운로드', description: '원본 미디어 다시 받기 (무료, 보조 도구)' },
    ],
  },
  briefs: {
    role: '브랜드 정보와 경쟁 광고 패턴을 바탕으로 광고 기획서와 문구 변형을 생성합니다. 만드는 방법은 두 가지 — 여기서 포커스 문장으로 만들면 비슷한 분석 광고 3건이 자동 참조되고, 광고 상세의 「브리프 생성」으로 만들면 그 광고가 직접 참조로 지정됩니다.',
    steps: ['브랜드와 포커스를 정하고 브리프를 생성합니다 (또는 광고 상세에서 특정 광고를 참조로 생성).', '상세의 「이 브리프가 참고한 것」 카드에서 어떤 광고·브랜드가 재료였는지 확인합니다.', '문구 변형과 zh-TW 초안을 만든 뒤 검토 탭으로 이동합니다.'],
    buttons: [
