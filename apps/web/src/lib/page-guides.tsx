...
export const pageGuides: Record<PageGuideKey, PageGuide> = {
  ...
  media: {
    role: '내 시안·참고 미디어를 올려 텍스트를 추출하고 인사이트를 뽑는 곳. 경쟁 광고 수집과 별개 트랙입니다.',
    steps: ['파일을 업로드합니다.', '텍스트를 추출하고 인사이트를 분석합니다.', '비슷한 경쟁 광고를 확인합니다.'],
    buttons: [
      { name: '업로드', description: '원본 파일을 저장합니다 (무료)' },
      { name: '미디어 텍스트 추출', description: '이미지 글자·영상 음성을 텍스트로 추출합니다 (AI, 건당 1~2센트)' },
      { name: '인사이트 분석', description: '훅·타깃·감정·장르를 분석합니다 (AI, 약 1센트)' },
      { name: '유사 광고', description: '비슷한 경쟁 광고를 검색합니다 (무료)' },
    ],
  },
  ads: {
